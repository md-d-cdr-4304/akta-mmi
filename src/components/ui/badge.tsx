...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 shadow-sm",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-border/50 bg-card/50 hover:bg-accent/30",
