  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-hero relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-primary/15 rounded-full blur-[140px]"></div>
      </div>
      ...
      <div className="w-full max-w-md mx-4 animate-fade-in-up">
        ...
        <div className="mt-6 p-4 bg-accent/30 backdrop-blur-sm rounded-xl border border-border/30 text-center">
          ...
          <p className="text-xs text-foreground/80">kiosk001@akta.com / kiosk123</p>
